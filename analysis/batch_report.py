                        ...
                        <td style="background: linear-gradient(135deg, #0f172a 0%, #1e293b 50%, #334155 100%); padding: 40px 50px; position: relative;">
                            ...
                            <div style="display: flex; gap: 40px; flex-wrap: wrap;">
                                <div>
                                    ...
                                    <div style="color: #ffffff; font-size: 14px; font-weight: 500; margin-top: 8px;">{gst_now.strftime('%B %d, %Y')}</div>
                                </div>
                                <div>
                                    ...
                                    <div style="color: #ffffff; font-size: 14px; font-weight: 500; margin-top: 8px;">{total_calls} Voice Calls</div>
                                </div>
                                <div>
                                    ...
                                    <div style="color: #ffffff; font-size: 14px; font-weight: 500; margin-top: 8px;">{success_rate}%</div>
                                </div>
                                <div>
                                    ...
                                    <div style="color: #ffffff; font-size: 14px; font-weight: 500; margin-top: 8px;">{report_time} GST</div>
                                </div>
                            </div>
                        </td>
                    </tr>
